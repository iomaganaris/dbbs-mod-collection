...
def package():
  ...
  #-mod_glia__dbbs_mod_collection__AMPA__Golgi_deterministic
  mod_glia__dbbs_mod_collection__AMPA__Golgi_deterministic = Mod()
  mod_glia__dbbs_mod_collection__AMPA__Golgi_deterministic.pkg_name = 'dbbs_mod_collection'
  mod_glia__dbbs_mod_collection__AMPA__Golgi_deterministic.asset_name = 'AMPA'
  mod_glia__dbbs_mod_collection__AMPA__Golgi_deterministic.variant = 'Golgi_deterministic'
  mod_glia__dbbs_mod_collection__AMPA__Golgi_deterministic.namespace = 'glia__dbbs_mod_collection'
  mod_glia__dbbs_mod_collection__AMPA__Golgi_deterministic._is_point_process = True
  mod_glia__dbbs_mod_collection__AMPA__Golgi_deterministic.pkg = pkg
  pkg.mods.append(mod_glia__dbbs_mod_collection__AMPA__Golgi_deterministic)
  #-##
  return pkg
